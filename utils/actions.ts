...
export const fetchSingerProduct = async (productId: string) => {
...
export const updateProductAction = async(preState:any , formData:FormData) => {
  await getAdminUser()
  try {
...
export const updateProductImageAction = async (prevSate:any , formData:FormData) => {
  await getAuthUser();
  try {
...
export const featchFavoriteId = async ({productId}:{productId:string}) => {
  const user = await getAuthUser()
...
export const toggleFavoriteAction = async (prevState:{productId:string , favoriteId:string | null, pathname:string}) => {
  ...
  try {
    ...
    return {message:favoriteId?'remove from faves':'add from faves'}
  } catch (error) {
    return renderError(error)
  }
}
...
export const createReviewAction = async (prevSate:any , formData:FormData) => {
  const user = await getAuthUser()
  try {
    const rawData = Object.fromEntries(formData)
...
export const deleteReviewAction = async (preState:{reviewId:string}) => {
  const {reviewId} = preState
  const user = await getAuthUser()
  try {
...
export const removeCartItemAction = async (prevSate:any , formData:FormData) => {
  const user = await getAuthUser()
  try {
...
export const createOrderAction = async (prevState : any , formData:FormData) => {
  ...
  redirect(`/checkout?orderId=${orderId}&cartId=${cardId}`)
}
